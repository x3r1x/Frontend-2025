import { addSlideToPresentation, changeSlidesOrder, deleteSlidesFromPresentation, renamePresentation } from "../../actions/presentationActions.js"
import { Presentation, Slide } from "../../types.js"
import { generateUUID, presentation, slide1, slide1Obj1, slide2, slide2obj1, slide2Obj3, slide3, slide4 } from "../maximumDataTestStorage.js"
...
function testRenamePresentation(): "passed" | "failed" {
    ...
    const actionedEntity: Presentation = renamePresentation(presentation, "x3r1x")
...
function testAddSlideToPresentation(): "passed" | "failed" {
    ...
    const actionedEntity: Presentation = addSlideToPresentation(presentation, newSlide)
...
function testDeleteSlidesFromPresentation(): "passed" | "failed" {
    ...
    const actionedEntity: Presentation = deleteSlidesFromPresentation(presentation, presentation.selection.selectedSlideIds)
...
function testChangeSlidesOrder(): "passed" | "failed" {
    ...
    const actionedEntity: Presentation = changeSlidesOrder(presentation, [slide3.id, slide2.id, slide4.id, slide1.id])
...
export function testMaxPresentationActions(): void {
    ...
    console.log('   2. addSlideToPresentation: ' + testAddSlideToPresentation() + "!")
    console.log('   3. deleteSlidesFromPresentation: ' + testDeleteSlidesFromPresentation() + "!")
