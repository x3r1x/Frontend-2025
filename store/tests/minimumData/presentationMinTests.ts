...
function testRenamePresentation(): "passed" | "failed" {    
    ...
    const actionedEntity: Presentation = renamePresentation(presentation, newName)
...
function testDeleteSlidesFromPresentation(): "passed" | "failed" {    
    ...
    const actionedEntity: Presentation = deleteSlidesFromPresentation(presentation, [slideId])
...
function testChangeSlidesOrder(): "passed" | "failed" {  
    ...
    const actionedEntity: Presentation = changeSlidesOrder(presentation, [slideId2, slideId1])
