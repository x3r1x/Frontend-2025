...
function testChangeText(): "passed" | "failed" {
  ...
  const actionedEntity: Presentation = changeText(
    presentation,
    "sdf1",
    "object1",
    "Text has changed",
...
function testChangeFontSize(): "passed" | "failed" {
  ...
  const actionedEntity: Presentation = changeFontSize(
    presentation,
    "sdf1",
    "object1",
    20,
...
function testChangeFontFamily(): "passed" | "failed" {
  ...
  const actionedEntity: Presentation = changeFontFamily(
    presentation,
    "sdf1",
    "object1",
    "Times New Roman",
