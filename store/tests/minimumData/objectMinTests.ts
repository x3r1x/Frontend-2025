...
function testChangeObjectPosition(): "passed" | "failed" {
    ...
    const actionedEntity: Presentation = changeObjectPosition(presentation, "sdf1", "object1", newPosition)
...
function testChangeObjectSize(): "passed" | "failed" {
    ...
    const actionedEntity: Presentation = changeObjectSize(presentation, "sdf1", "object1", newSize)
